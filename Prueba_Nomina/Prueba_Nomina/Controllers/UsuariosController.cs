...
namespace Prueba_Nomina.Controllers
{
    public class UsuariosController: Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<IActionResult> Registro(RegistroView modelo) {
        ...
        public async Task<IActionResult> Login(LoginViewModel modelo) {
            ...
            var resultado = await signInManager.PasswordSignInAsync(modelo.Email, modelo.Password, modelo.RememberMe, lockoutOnFailure: false);
